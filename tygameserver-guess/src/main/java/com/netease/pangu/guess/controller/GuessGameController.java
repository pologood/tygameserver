package com.netease.pangu.guess.controller;
...
import com.netease.pangu.guess.service.GuessGameService;

import javax.annotation.Resource;
import java.util.Map;

@HttpController(value = "/guess", moduleId = GameConst.GUESSS)
@WsRpcController(value = "/guess", moduleId = GameConst.GUESSS)
